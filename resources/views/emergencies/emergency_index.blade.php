          ...
          @endif
              <table id="example1" class="table table-bordered table-striped mm-left">
                ...
                <?php foreach ($emergencies as $emergency): ?>
                    ...
                    <td> 
                      <a href="/emergency/detail/{{$emergency->attention_id}}" title="Ver detalles" > <button  type="button" class="btn btn-primary btn-flat buttonSpace"><i class="fa fa-eye"></i></button></a>
                      <a href="/emergency/remove/{{$emergency->attention_id}}" title="Eliminar" ><button  type="button" class="btn btn-danger btn-flat buttonSpace " onclick="return confirm('¿Estas seguro de que quieres eliminar esta solicitud de servicio Docdoor?');"><i class="fa fa-trash"></i></button><a>
                    </td>
                    </tr>  
                    <?php endforeach ?>  
