          ...
          <div class="box">
            ...
            <a href="/emergency/add">  
                <button type="button" class="btn  bg-olive margin">
                 <h5 ><i class="fa fa-plus"></i>  Añadir una Emergencia</h5>
                </button>
              </a>
          </div>
            <!-- /.box-header -->
              ...
              <table id="example1" class="table table-bordered table-striped mm-left">
                ...
                <?php foreach ($emergencies as $emergency): ?>
                    ...
                    <td> 
                      ...
                      <a href="/emergency/remove/{{$emergency->attention_id}}"><button  type="button" class="btn btn-danger btn-flat buttonSpace " onclick="return confirm('¿Estas seguro de que quieres eliminar esta solicitud de servicio Docdoor?');"><i class="fa fa-trash"></i></button><a>
                    </td>
                    </tr>  
                    <?php endforeach ?>  
